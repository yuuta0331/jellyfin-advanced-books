(function () {
    ...
    const dictionaries = {
        ...
        ja: {
            ...
            'Auto-scroll': '自動スクロール',
            'Page position': 'ページ位置',
            'Resize settings panel': '設定パネルのサイズを変更',
            'Navigation': 'ナビゲーション',
            'Zoom & pan': '拡大・移動',
            'Reader': 'リーダー',
            'Show': '表示',
            ...
            'Left / right tap': '左右タップ',
            'Top / bottom tap': '上下タップ',
            'Previous / next page in Vertical / Webtoon': '縦読み / Webtoonで前 / 次のページ',
            'Mouse drag': 'マウスドラッグ',
            'Grab and pan the page / continuous canvas': 'ページ / 連続キャンバスを掴んで移動',
            'Drag': 'ドラッグ',
            'Book': '本'
        },
        de: {
            ...
            'Reader language': 'Reader-Sprache',
            'Reading': 'Lesen',
            ...
            'Resize settings panel': 'Einstellungsbereich vergrößern/verkleinern',
            ...
            'Left / right tap': 'Links / rechts tippen',
            'Top / bottom tap': 'Oben / unten tippen',
            'Previous / next page in Vertical / Webtoon': 'Vorherige / nächste Seite in Vertikal / Webtoon',
            'Mouse drag': 'Mit der Maus ziehen',
            'Grab and pan the page / continuous canvas': 'Seite / fortlaufende Fläche greifen und verschieben',
            'Drag': 'Ziehen',
            'Book': 'Buch'
        },
        fr: {
            ...
            'Reader language': 'Langue du lecteur',
            'Reading': 'Lecture',
            ...
            'Page position': 'Position de page',
            'Resize settings panel': 'Redimensionner le panneau des paramètres',
            'Navigation': 'Navigation',
            'Zoom & pan': 'Zoom et déplacement',
            'Reader': 'Lecteur',
            'Show': 'Afficher',
            'Hide': 'Masquer',
            'On': 'Activé',
            ...
            'Left / right tap': 'Appui gauche / droite',
            'Top / bottom tap': 'Appui haut / bas',
            'Previous / next page in Vertical / Webtoon': 'Page précédente / suivante en Vertical / Webtoon',
            'Mouse drag': 'Glisser à la souris',
            'Grab and pan the page / continuous canvas': 'Saisir et déplacer la page / le canevas continu',
            'Drag': 'Glisser',
            'Book': 'Livre'
        },
        es: {
            ...
            'Reader language': 'Idioma del lector',
            'Reading': 'Lectura',
            ...
            'Resize settings panel': 'Cambiar tamaño del panel de ajustes',
            ...
            'Left / right tap': 'Toque izquierda / derecha',
            'Top / bottom tap': 'Toque arriba / abajo',
            'Previous / next page in Vertical / Webtoon': 'Página anterior / siguiente en Vertical / Webtoon',
            'Mouse drag': 'Arrastre con ratón',
            'Grab and pan the page / continuous canvas': 'Agarrar y desplazar la página / lienzo continuo',
            'Drag': 'Arrastrar',
            'Book': 'Libro'
        },
        'zh-CN': {
            ...
            'Auto-scroll': '自动滚动',
            'Page position': '页面位置',
            'Resize settings panel': '调整设置面板大小',
            'Navigation': '导航',
            'Zoom & pan': '缩放与平移',
            'Reader': '阅读器',
            'Show': '显示',
            ...
            'Left / right tap': '点击左侧 / 右侧',
            'Top / bottom tap': '点击上方 / 下方',
            'Previous / next page in Vertical / Webtoon': '纵向 / Webtoon 中上一页 / 下一页',
            'Mouse drag': '鼠标拖动',
            'Grab and pan the page / continuous canvas': '抓住并移动页面 / 连续画布',
            'Drag': '拖动',
            'Book': '书籍'
        }
    };
